# Contributing to purrr

This outlines how to propose a change to purrr. For more detailed info
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("batpigandme/purrr", fork = TRUE)`.
...
Please note that the purrr project is released with a [Contributor Code
of Conduct](https://purrr.tidyverse.org/dev/CODE_OF_CONDUCT.md). By
