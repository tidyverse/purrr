...
- All functions that were soft-deprecated in purrr 1.0.0 are now fully
  ...
  `invoke_*()`, `lift_*()`, `cross*()`,
  [`prepend()`](https://purrr.tidyverse.org/dev/reference/prepend.md),
  [`splice()`](https://purrr.tidyverse.org/dev/reference/splice.md),
  [`rbernoulli()`](https://purrr.tidyverse.org/dev/reference/rbernoulli.md),
  [`rdunif()`](https://purrr.tidyverse.org/dev/reference/rdunif.md),
  [`when()`](https://purrr.tidyverse.org/dev/reference/when.md),
  [`update_list()`](https://purrr.tidyverse.org/dev/reference/update_list.md),
  `*_raw()`,
  [`vec_depth()`](https://purrr.tidyverse.org/dev/reference/pluck_depth.md).

- [`map_chr()`](https://purrr.tidyverse.org/dev/reference/map.md) no
  longer coereces from logical, integer, or double to strings.

- [`every()`](https://purrr.tidyverse.org/dev/reference/every.md),
  [`some()`](https://purrr.tidyverse.org/dev/reference/every.md), and
  [`none()`](https://purrr.tidyverse.org/dev/reference/every.md) now
  require that `.p` return logical scalar `TRUE`, `FALSE`, or `NA`.
  Previously, `NA` was allowed to be a non-logical `NA`, and would be
  coerced to a logical `NA`.

### Minor improvements and bug fixes

- New “getting started” vignette,
  [`vignette("purrr")`](https://purrr.tidyverse.org/dev/articles/purrr.md)
  ([\#915](https://github.com/tidyverse/purrr/issues/915),
  [@ogolovkina](https://github.com/ogolovkina)).

- [`every()`](https://purrr.tidyverse.org/dev/reference/every.md),
  [`some()`](https://purrr.tidyverse.org/dev/reference/every.md), and
  [`none()`](https://purrr.tidyverse.org/dev/reference/every.md) are now
...
- [`map()`](https://purrr.tidyverse.org/dev/reference/map.md),
  [`map2()`](https://purrr.tidyverse.org/dev/reference/map2.md), and
  [`pmap()`](https://purrr.tidyverse.org/dev/reference/pmap.md) now
...
- [`map_vec()`](https://purrr.tidyverse.org/dev/reference/map.md) no
  longer fails on empty named lists
...
- Deprecation infrastructure in
  [`map_chr()`](https://purrr.tidyverse.org/dev/reference/map.md) now
  has much less overhead leading to improved performance
...
- As of purrr 1.0.0, the
  [`map()`](https://purrr.tidyverse.org/dev/reference/map.md) family of
...
- [`map()`](https://purrr.tidyverse.org/dev/reference/map.md) errors
  with named inputs also report the name of the element that errored.

- Fixed an issue where progress bars weren’t being closed when user
  interrupts or errors were encountered during a
  [`map()`](https://purrr.tidyverse.org/dev/reference/map.md) call
...
- [`cross()`](https://purrr.tidyverse.org/dev/reference/cross.md) and
  all its variants have been deprecated in favour of
...
- [`update_list()`](https://purrr.tidyverse.org/dev/reference/update_list.md)
  ...
  [`rerun()`](https://purrr.tidyverse.org/dev/reference/rerun.md)
...
- [`prepend()`](https://purrr.tidyverse.org/dev/reference/prepend.md),
  [`rdunif()`](https://purrr.tidyverse.org/dev/reference/rdunif.md),
  [`rbernoulli()`](https://purrr.tidyverse.org/dev/reference/rbernoulli.md),
  [`when()`](https://purrr.tidyverse.org/dev/reference/when.md), and
  [`list_along()`](https://purrr.tidyverse.org/dev/reference/along.md)
  have all been deprecated
  ([\#925](https://github.com/tidyverse/purrr/issues/925)). It’s now
  clear that they don’t align with the core purpose of purrr.

- [`splice()`](https://purrr.tidyverse.org/dev/reference/splice.md) is
...
- All map `_raw()` variants have been deprecated because they are of
  ...
  instead ([\#903](https://github.com/tidyverse/purrr/issues/903)).

- In [`map_chr()`](https://purrr.tidyverse.org/dev/reference/map.md),
...
- Soft deprecated functions: `%@%`, `reduce_right()`, `reduce2_right()`,
  ...
  [`partial()`](https://purrr.tidyverse.org/dev/reference/partial.md),
  and the `.right` argument to
  [`detect()`](https://purrr.tidyverse.org/dev/reference/detect.md) and
...
- New [`map_vec()`](https://purrr.tidyverse.org/dev/reference/map.md),
  [`map2_vec()`](https://purrr.tidyverse.org/dev/reference/map2.md), and
  [`pmap_vec()`](https://purrr.tidyverse.org/dev/reference/pmap.md) work
  on all types of vectors, extending
  [`map_lgl()`](https://purrr.tidyverse.org/dev/reference/map.md),
  [`map_int()`](https://purrr.tidyverse.org/dev/reference/map.md), and
...
- New
  ...
  that work like
  [`keep()`](https://purrr.tidyverse.org/dev/reference/keep.md) and
  [`discard()`](https://purrr.tidyverse.org/dev/reference/keep.md) but
...
- [`modify()`](https://purrr.tidyverse.org/dev/reference/modify.md),
  ...
  and [`modify2()`](https://purrr.tidyverse.org/dev/reference/modify.md)
  are no longer generics. We have discovered a simple implementation
  that no longer requires genericity and methods were only provided by a
...
- [`map2()`](https://purrr.tidyverse.org/dev/reference/map2.md),
  ...
  and [`pmap()`](https://purrr.tidyverse.org/dev/reference/pmap.md) now
  use tidyverse recycling rules where vectors of length 1 are recycled
  to any size but all others must have the same length
  ([\#878](https://github.com/tidyverse/purrr/issues/878)).

- [`map2()`](https://purrr.tidyverse.org/dev/reference/map2.md) and
  [`pmap()`](https://purrr.tidyverse.org/dev/reference/pmap.md) now
  recycle names of their first input if needed
...
- [`modify()`](https://purrr.tidyverse.org/dev/reference/modify.md),
  ...
  and
  [`modify_at()`](https://purrr.tidyverse.org/dev/reference/modify.md)
  have been reimplemented using vctrs principles. This shouldn’t have an
  user facing impact, but it does make the implementation much simpler.
...
- [`pluck()`](https://purrr.tidyverse.org/dev/reference/pluck.md) now
...
- [`pluck()`](https://purrr.tidyverse.org/dev/reference/pluck.md) and
  [`chuck()`](https://purrr.tidyverse.org/dev/reference/chuck.md) now
  fail if you provide named inputs to …
  ([\#788](https://github.com/tidyverse/purrr/issues/788)).

- [`pluck()`](https://purrr.tidyverse.org/dev/reference/pluck.md) no
  longer replaces 0-length vectors with `default`; it now only applies
  absent and `NULL` components
  ([\#480](https://github.com/tidyverse/purrr/issues/480)).

- `pluck<-`/[`assign_in()`](https://purrr.tidyverse.org/dev/reference/modify_in.md)
...
- [`modify()`](https://purrr.tidyverse.org/dev/reference/modify.md),
  ...
  and
  [`modify_if()`](https://purrr.tidyverse.org/dev/reference/modify.md)
  now correctly handle `NULL`s in replacement values
...
- [`list_modify()`](https://purrr.tidyverse.org/dev/reference/list_assign.md)’s
...
- [`modify()`](https://purrr.tidyverse.org/dev/reference/modify.md) no
...
- [`lmap_if()`](https://purrr.tidyverse.org/dev/reference/lmap.md)
  correctly handles `.else` functions
  ([\#847](https://github.com/tidyverse/purrr/issues/847)).

- [`every()`](https://purrr.tidyverse.org/dev/reference/every.md) now
  ...
  `&&` and also with
  [`some()`](https://purrr.tidyverse.org/dev/reference/every.md) which
  has always been a wrapper around `||` with the same propagation rules.

- [`every()`](https://purrr.tidyverse.org/dev/reference/every.md) and
  [`some()`](https://purrr.tidyverse.org/dev/reference/every.md) now
...
- [`partial()`](https://purrr.tidyverse.org/dev/reference/partial.md) no
  longer inlines the function in the call stack. This fixes issues when
  [`partial()`](https://purrr.tidyverse.org/dev/reference/partial.md) is
...
- Added [`none()`](https://purrr.tidyverse.org/dev/reference/every.md),
  which tests that a predicate is false for all elements (the opposite
  of [`every()`](https://purrr.tidyverse.org/dev/reference/every.md))
...
- [`reduce()`](https://purrr.tidyverse.org/dev/reference/reduce.md) now
  forces arguments
...
- [`negate()`](https://purrr.tidyverse.org/dev/reference/negate.md) now
...
- [`prepend()`](https://purrr.tidyverse.org/dev/reference/prepend.md)
  now works with empty lists ([@czeildi](https://github.com/czeildi),
...
- [`modify()`](https://purrr.tidyverse.org/dev/reference/modify.md) and
...
- All functionals taking predicate functions (like
  ...
  [`some()`](https://purrr.tidyverse.org/dev/reference/every.md)) got
...
- New [`chuck()`](https://purrr.tidyverse.org/dev/reference/chuck.md)
  function. This is a strict variant of
  [`pluck()`](https://purrr.tidyverse.org/dev/reference/pluck.md) that
...
- New `.else` argument for
  [`map_if()`](https://purrr.tidyverse.org/dev/reference/map_if.md) and
  [`modify_if()`](https://purrr.tidyverse.org/dev/reference/modify.md).
  They take an alternative function that is mapped over elements of the
  input for which the predicate function returns `FALSE`
...
- Functions taking predicates
  ...
  [`every()`](https://purrr.tidyverse.org/dev/reference/every.md),
  [`keep()`](https://purrr.tidyverse.org/dev/reference/keep.md), etc)
  now fail with an informative message when the return value is not
  `TRUE` or `FALSE`
  ([\#470](https://github.com/tidyverse/purrr/issues/470)).

  This is a breaking change for
  [`every()`](https://purrr.tidyverse.org/dev/reference/every.md) and
  [`some()`](https://purrr.tidyverse.org/dev/reference/every.md) which
  were documented to be more liberal in the values they accepted as
  logical (any vector was considered `TRUE` if not a single `FALSE`
  value, no matter its length). These functions signal soft-deprecation
  warnings instead of a hard failure.

  Edit (purr 0.4.0):
  [`every()`](https://purrr.tidyverse.org/dev/reference/every.md) and
  [`some()`](https://purrr.tidyverse.org/dev/reference/every.md) never
  ...
  [`every()`](https://purrr.tidyverse.org/dev/reference/every.md) and
  [`some()`](https://purrr.tidyverse.org/dev/reference/every.md) in
  contexts where `NA` propagation is unsafe, e.g. in `if ()` conditions,
  make sure to use safe predicate functions like `is_true()`.
...
- New [`modify2()`](https://purrr.tidyverse.org/dev/reference/modify.md)
  and [`imodify()`](https://purrr.tidyverse.org/dev/reference/modify.md)
  functions. These work like
  [`map()`](https://purrr.tidyverse.org/dev/reference/map.md) and
  [`imap()`](https://purrr.tidyverse.org/dev/reference/imap.md) but
  preserve the type of `.x` in the return value.

- [`pmap()`](https://purrr.tidyverse.org/dev/reference/pmap.md) and
  [`pwalk()`](https://purrr.tidyverse.org/dev/reference/pmap.md) now
...
- [`modify()`](https://purrr.tidyverse.org/dev/reference/modify.md),
  ...
  and
  [`modify_at()`](https://purrr.tidyverse.org/dev/reference/modify.md)
  now preserve the class of atomic vectors instead of promoting them to
...
- [`map_at()`](https://purrr.tidyverse.org/dev/reference/map_if.md),
  [`modify_at()`](https://purrr.tidyverse.org/dev/reference/modify.md)
  and [`lmap_at()`](https://purrr.tidyverse.org/dev/reference/lmap.md)
  accept negative values for `.at`, ignoring elements at those
  positions.

- [`map()`](https://purrr.tidyverse.org/dev/reference/map.md) and
  [`modify()`](https://purrr.tidyverse.org/dev/reference/modify.md) now
  work with calls and pairlists
...
- New
  ...
  [`accumulate()`](https://purrr.tidyverse.org/dev/reference/accumulate.md)
  what
  [`reduce2()`](https://purrr.tidyverse.org/dev/reference/reduce.md) is
  to [`reduce()`](https://purrr.tidyverse.org/dev/reference/reduce.md).
...
- New
  ...
  [`slowly()`](https://purrr.tidyverse.org/dev/reference/slowly.md), or
  the lower level function
  [`rate_sleep()`](https://purrr.tidyverse.org/dev/reference/rate_sleep.md).
...
- `insistently(f)` modifies a function, `f`, so that it is repeatedly
  ...
  modifies a function so that it waits for a given amount of time
  between calls.

### `partial()`

The interface of
[`partial()`](https://purrr.tidyverse.org/dev/reference/partial.md) has
been simplified. It now supports quasiquotation to control the timing of
evaluation, and the
...
- [`partial()`](https://purrr.tidyverse.org/dev/reference/partial.md)
  now supports empty `... =` argument to specify the position of future
...
- [`partial()`](https://purrr.tidyverse.org/dev/reference/partial.md)
  now supports quasiquotation. When you unquote an argument, it is
  evaluated only once at function creation time. This is more flexible
  than the `.lazy` argument since you can control the timing of
  evaluation for each argument. Consequently, `.lazy` is soft-deprecated
...
- [`partial()`](https://purrr.tidyverse.org/dev/reference/partial.md)
  now calls `as_closure()` on primitive functions to ensure argument
...
- [`compose()`](https://purrr.tidyverse.org/dev/reference/compose.md)
  now returns an identity function when called without inputs.

- Functions created with
  [`compose()`](https://purrr.tidyverse.org/dev/reference/compose.md)
  now have the same formal parameters as the first function to be
  called. They also feature a more informative print method that prints
  all composed functions in turn ([@egnha](https://github.com/egnha),
  [\#366](https://github.com/tidyverse/purrr/issues/366)).

- New `.dir` argument in
  [`compose()`](https://purrr.tidyverse.org/dev/reference/compose.md).
  When set to `"forward"`, the functions are composed from left to right
...
- Fixed a [`pmap()`](https://purrr.tidyverse.org/dev/reference/pmap.md)
...
- [`imap_dfr()`](https://purrr.tidyverse.org/dev/reference/map_dfr.md)
  now works with `.id` argument is provided
...
- [`pluck()`](https://purrr.tidyverse.org/dev/reference/pluck.md) no
  longer flattens lists of arguments. You can still do it manually with
  `!!!`. This change is for consistency with other dots-collecting
  functions of the tidyverse.

- [`map_at()`](https://purrr.tidyverse.org/dev/reference/map_if.md),
  [`lmap_at()`](https://purrr.tidyverse.org/dev/reference/lmap.md) and
  [`modify_at()`](https://purrr.tidyverse.org/dev/reference/modify.md)
...
- [`detect()`](https://purrr.tidyverse.org/dev/reference/detect.md) now
  has a .default argument to specify the value returned when nothing is
...
- The `.right` argument of
  [`detect()`](https://purrr.tidyverse.org/dev/reference/detect.md) and
  [`detect_index()`](https://purrr.tidyverse.org/dev/reference/detect.md)
  is soft-deprecated and renamed to `.dir` for consistency with other
...
The interface of
[`partial()`](https://purrr.tidyverse.org/dev/reference/partial.md) has
been simplified (see more about
[`partial()`](https://purrr.tidyverse.org/dev/reference/partial.md)
below):
...
- We had to rename `...f` to `.f` in
  [`partial()`](https://purrr.tidyverse.org/dev/reference/partial.md) in
  order to support `... =` argument (which would otherwise partial-match
  on `...f`). This also makes
  [`partial()`](https://purrr.tidyverse.org/dev/reference/partial.md)
  more consistent with other purrr function signatures.

#### Retirement of `invoke()`

[`invoke()`](https://purrr.tidyverse.org/dev/reference/invoke.md) and
[`invoke_map()`](https://purrr.tidyverse.org/dev/reference/invoke.md)
are retired in favour of
...
- [`invoke()`](https://purrr.tidyverse.org/dev/reference/invoke.md) is
...
- [`invoke_map()`](https://purrr.tidyverse.org/dev/reference/invoke.md)
  is retired without replacement because it is more complex to
  understand than the corresponding code using
  [`map()`](https://purrr.tidyverse.org/dev/reference/map.md),
  [`map2()`](https://purrr.tidyverse.org/dev/reference/map2.md) and
...
- [`rerun()`](https://purrr.tidyverse.org/dev/reference/rerun.md) is now
  in the questioning stage because we are no longer convinced NSE
  functions are a good fit for purrr. Also, `rerun(n, x)` can just as
  easily be expressed as `map(1:n, ~ x)` (with the added benefit of
  being passed the current index as argument to the lambda).
...
- If [`reduce()`](https://purrr.tidyverse.org/dev/reference/reduce.md)
...
[`map()`](https://purrr.tidyverse.org/dev/reference/map.md) has been
extracted into the function
[`pluck()`](https://purrr.tidyverse.org/dev/reference/pluck.md).
Plucking is often more readable to extract an element buried in a deep
data structure. Compare this syntax-heavy extraction which reads
non-linearly:
...
- [`possibly()`](https://purrr.tidyverse.org/dev/reference/possibly.md),
  [`safely()`](https://purrr.tidyverse.org/dev/reference/safely.md) and
...
- All [`map()`](https://purrr.tidyverse.org/dev/reference/map.md)
  functions now force their arguments in the same way that base R does
  for [`lapply()`](https://rdrr.io/r/base/lapply.html)
  ([\#191](https://github.com/tidyverse/purrr/issues/191)). This makes
  [`map()`](https://purrr.tidyverse.org/dev/reference/map.md) etc easier
  to use when generating functions.

- A new family of “indexed” map functions,
  [`imap()`](https://purrr.tidyverse.org/dev/reference/imap.md),
  [`imap_lgl()`](https://purrr.tidyverse.org/dev/reference/imap.md) etc,
...
A new [`modify()`](https://purrr.tidyverse.org/dev/reference/modify.md)
family returns the same output of the type as the input `.x`. This is in
contrast to the
[`map()`](https://purrr.tidyverse.org/dev/reference/map.md) family which
always returns a list, regardless of the input type.
...
- [`reduce2()`](https://purrr.tidyverse.org/dev/reference/reduce.md) and
...
- [`compact()`](https://purrr.tidyverse.org/dev/reference/keep.md) now
  works with standard mapper conventions
  ([\#282](https://github.com/tidyverse/purrr/issues/282)).

- `cross_n()` has been renamed to
  [`cross()`](https://purrr.tidyverse.org/dev/reference/cross.md). The
  `_n` suffix was removed for consistency with
  [`pmap()`](https://purrr.tidyverse.org/dev/reference/pmap.md)
  (originally called `map_n()` at the start of the project) and
  [`transpose()`](https://purrr.tidyverse.org/dev/reference/transpose.md)
  (originally called `zip_n()`). Similarly, `cross_d()` has been renamed
  to [`cross_df()`](https://purrr.tidyverse.org/dev/reference/cross.md)
  for consistency with
  [`map_df()`](https://purrr.tidyverse.org/dev/reference/map_dfr.md).

- [`every()`](https://purrr.tidyverse.org/dev/reference/every.md) and
  [`some()`](https://purrr.tidyverse.org/dev/reference/every.md) now
  return `NA` if present in the input
  ([\#174](https://github.com/tidyverse/purrr/issues/174)).

- [`invoke()`](https://purrr.tidyverse.org/dev/reference/invoke.md) uses
  a more robust approach to generate the argument list
...
- [`pmap()`](https://purrr.tidyverse.org/dev/reference/pmap.md) coerces
  data frames to lists to avoid the expensive `[.data.frame` which
  provides security that is unneeded here
...
- [`safely()`](https://purrr.tidyverse.org/dev/reference/safely.md) now
...
- [`flatten()`](https://purrr.tidyverse.org/dev/reference/flatten.md) is
  now type-stable and always returns a list. To return a simpler vector,
  use
  ...
  or
  [`flatten_df()`](https://purrr.tidyverse.org/dev/reference/flatten.md).

- [`invoke()`](https://purrr.tidyverse.org/dev/reference/invoke.md) has
  been overhauled to be more useful: it now works similarly to
  `map_call()` when `.x` is NULL, and hence `map_call()` has been
  deprecated.
  [`invoke_map()`](https://purrr.tidyverse.org/dev/reference/invoke.md)
  is a vectorised complement to
  [`invoke()`](https://purrr.tidyverse.org/dev/reference/invoke.md)
  ([\#125](https://github.com/tidyverse/purrr/issues/125)), and comes
  with typed variants
  [`invoke_map_lgl()`](https://purrr.tidyverse.org/dev/reference/invoke.md),
  [`invoke_map_int()`](https://purrr.tidyverse.org/dev/reference/invoke.md),
  [`invoke_map_dbl()`](https://purrr.tidyverse.org/dev/reference/invoke.md),
  [`invoke_map_chr()`](https://purrr.tidyverse.org/dev/reference/invoke.md),
  and
  [`invoke_map_df()`](https://purrr.tidyverse.org/dev/reference/invoke.md).
...
- [`safely()`](https://purrr.tidyverse.org/dev/reference/safely.md),
  ...
  and
  [`possibly()`](https://purrr.tidyverse.org/dev/reference/possibly.md)
  are experimental functions for working with functions with
  side-effects (e.g. printed output, messages, warnings, and errors)
  ([\#120](https://github.com/tidyverse/purrr/issues/120)).
  [`safely()`](https://purrr.tidyverse.org/dev/reference/safely.md) is a
...
- [`list_along()`](https://purrr.tidyverse.org/dev/reference/along.md)
  and [`rep_along()`](https://rlang.r-lib.org/reference/rep_along.html)
...
- [`pmap()`](https://purrr.tidyverse.org/dev/reference/pmap.md)
  ...
  [`pmap_chr()`](https://purrr.tidyverse.org/dev/reference/pmap.md), and
  [`pmap_df()`](https://purrr.tidyverse.org/dev/reference/map_dfr.md).
...
- [`map()`](https://purrr.tidyverse.org/dev/reference/map.md) now always
  returns a list. Data frame support has been moved to
  [`map_df()`](https://purrr.tidyverse.org/dev/reference/map_dfr.md) and
...
- [`rerun()`](https://purrr.tidyverse.org/dev/reference/rerun.md) is
  correctly scoped
...
- [`map_lgl()`](https://purrr.tidyverse.org/dev/reference/map.md) now
  has second argument `.f`, not `.p`
  ([\#134](https://github.com/tidyverse/purrr/issues/134)).

### Deprecated functions

- `flatmap()` -\> use
  [`map()`](https://purrr.tidyverse.org/dev/reference/map.md) followed
  by the appropriate
  [`flatten()`](https://purrr.tidyverse.org/dev/reference/flatten.md).
...
- `map_n()` -\>
  [`pmap()`](https://purrr.tidyverse.org/dev/reference/pmap.md);
  `walk_n()` -\>
  [`pwalk()`](https://purrr.tidyverse.org/dev/reference/pmap.md).
