...
similar to `[[` see
[`pluck()`](https://purrr.tidyverse.org/dev/reference/pluck.md)/[`chuck()`](https://purrr.tidyverse.org/dev/reference/chuck.md)).
...
[`keep()`](https://purrr.tidyverse.org/dev/reference/keep.md)/[`discard()`](https://purrr.tidyverse.org/dev/reference/keep.md)
