...
applies a 2-argument function in the same way, but discards all results
except that of the final function application.
...
[`reduce()`](https://purrr.tidyverse.org/dev/reference/reduce.md) when
you only need the final reduced value.
