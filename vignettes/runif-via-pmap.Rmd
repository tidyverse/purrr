...
The main goal of this vignette is to show how one can interate over rows using functions from purrr package. 
...
- Write custom wrappers around `runif()` to deal with:
