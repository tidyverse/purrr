...
These [`map()`](https://purrr.tidyverse.org/reference/map.md),
[`map2()`](https://purrr.tidyverse.org/reference/map2.md),
[`imap()`](https://purrr.tidyverse.org/reference/imap.md), and
[`pmap()`](https://purrr.tidyverse.org/reference/pmap.md) variants
...
[`map2()`](https://purrr.tidyverse.org/reference/map2.md), etc with
[`list_rbind()`](https://purrr.tidyverse.org/reference/list_c.md) and
[`list_cbind()`](https://purrr.tidyverse.org/reference/list_c.md). These
use
