...
[`pmap()`](https://purrr.tidyverse.org/reference/pmap.md), and friends.
It wraps errors thrown during the processing on individual elements with
...
[`map()`](https://purrr.tidyverse.org/reference/map.md) throws will
